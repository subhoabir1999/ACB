                ...
                <div class="col-md-12">
                    ...
                    <div class="card card-primary">
                        <div class="card-header">
                            <h3 class="card-title">Update Statistics</h3>
                        ...
                        <!-- /.card-header -->
                        <!-- form start -->
                        <form method="POST" action="{{ route('update_stat') }}" id="add_pr" enctype="multipart/form-data">
                            @csrf
                            <input type="hidden" id="stat_id" name="stat_id" value="{{ $stat->id }}">
                            <div class="card-body">
                                @if(session('message'))
