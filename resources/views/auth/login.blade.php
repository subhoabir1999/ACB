...
<head>
  ...
  <title>Anti Corruption Bureau Maharashtra | Administrative Section | Login</title>
...
<div class="login-box">
  ...
  <div class="card card-outline card-primary" >
    ...
    <div class="card-header text-center">
      <img src="{{ asset('admin/logo.png') }}" style="width: 100px;">
    </div>
    <div class="card-header text-center">
      
      <a href="/login" class="h6"><b style="text-transform: uppercase;">Anti Corruption Bureau Maharashtra </b>Administrative Login</a>
    </div>
    <div class="card-body">
