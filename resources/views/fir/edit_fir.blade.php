                ...
                <div class="col-md-12">
                    ...
                    <div class="card card-primary">
                        <div class="card-header">
                            <h3 class="card-title">Update FIR</h3>
                            <a href="{{ route('fir_list') }}" class="btn btn-warning btn-block btn-flat btn-sm"
                                style="float: right;width:150px;color: black;"><i class="fa fa-users"></i> FIR
                                List</a>

                        </div>
                        <!-- /.card-header -->
                        <!-- form start -->
                        <form method="POST" action="{{ route('update_fir') }}" id="add_pr" enctype="multipart/form-data">
                            @csrf
                            <input type="hidden" id="fir_id" name="fir_id" value="{{ $fir->id }}">
                            <div class="card-body">
                                @if(session('message'))
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label class="required" for="exampleInputEmail1">FIR Title</label>
                                            <input id="title" type="text"
                                                class="form-control @error('title') is-invalid @enderror" name="title"
                                                value="{{ $fir->title }}" required autofocus>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input id="title_mr" type="text"
                                                ...
                                                name="title_mr" value="{{ $fir->title_mr }}" required autofocus>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input id="title_hi" type="text"
                                                ...
                                                name="title_hi" value="{{ $fir->title_hi }}" autofocus>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <select id="range" class="form-control @error('range') is-invalid @enderror"
                                                ...
                                                <option value="{{ $range->id }}" @if($fir->range==$range->id) selected @endif>{{ $range->title }}</option>
                                                @endforeach
                                            </select>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <select id="unit" class="form-control @error('unit') is-invalid @enderror"
                                                ...
                                                <option value="">Select</option>
                                                @foreach ($unit as $u)
                                                <option value="{{ $u->id }}" @if($fir->unit==$u->id) selected @endif>{{ $u->title }}</option>
                                                @endforeach
                                            </select>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="date" id="date" class="form-control @error('date') is-invalid @enderror" name="date" value="{{$fir->date}}" required>
