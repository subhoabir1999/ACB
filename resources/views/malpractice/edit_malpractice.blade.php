                ...
                <div class="col-md-12">
                    ...
                    <div class="card card-primary">
                        <div class="card-header">
                            <h3 class="card-title">Update Malpractice</h3>
                            <a href="{{ route('mp_list') }}" class="btn btn-warning btn-block btn-flat btn-sm"
                        ...
                        <!-- /.card-header -->
                        <!-- form start -->
                        <form method="POST" action="{{ route('update_mp') }}" id="add_pr" enctype="multipart/form-data">
                            @csrf
                            <input type="hidden" id="mp_id" name="mp_id" value="{{ $pr->id }}">
                            <div class="card-body">
                                @if(session('message'))
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <select id="dept" class="form-control @error('dept') is-invalid @enderror"
                                                ...
                                                <option value="{{ $type->id }}" @if($pr->dept==$type->id) selected @endif>{{ $type->title }}</option>
                                                @endforeach
                                            </select>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            value="{{ $pr->from_date }}" name="from_date" required>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            value="{{ $pr->to_date }}" name="to_date" required>
