                ...
                <div class="col-md-12">
                    ...
                    <div class="card card-primary">
                        <div class="card-header">
                            <h3 class="card-title">Update Press Release</h3>
                        ...
                        <!-- /.card-header -->
                        <!-- form start -->
                        <form method="POST" action="{{ route('update_pr') }}" id="add_pr" enctype="multipart/form-data">
                            @csrf
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input id="title" type="text"
                                                ...
                                                value="{{ $pr->title }}" required autofocus>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input id="title_mr" type="text"
                                                ...
                                                name="title_mr" value="{{ $pr->title_mr }}" required autofocus>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input id="title_hi" type="text"
                                                ...
                                                name="title_hi" value="{{ $pr->title_hi }}" autofocus>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <select id="type" class="form-control @error('type') is-invalid @enderror"
                                                ...
                                                <option value="{{ $type->id }}" @if($pr->type==$type->id) selected @endif>{{ $type->title }}</option>
                                                @endforeach
                                            </select>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <select id="range" class="form-control @error('range') is-invalid @enderror"
                                                ...
                                                <option value="{{ $range->id }}" @if($pr->range==$range->id) selected @endif>{{ $range->title }}</option>
                                                @endforeach
                                            </select>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <select id="unit" class="form-control @error('unit') is-invalid @enderror"
                                                ...
                                                <option value="">Select</option>
                                                @foreach ($unit as $u)
                                                <option value="{{ $u->id }}" @if($pr->unit==$u->id) selected @endif>{{ $u->title }}</option>
                                                @endforeach
                                            </select>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="date" id="date" class="form-control @error('date') is-invalid @enderror" name="date" value="{{$pr->date}}" required>
